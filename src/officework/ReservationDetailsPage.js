...
class ReservationDetailsPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isApproved: true,
    ...
    render() {
        return (
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View >
                    <CustomToolbarWithBack title={"Reservation Details"} navigation={this.props.navigation} backgroundColor="#FFFFFF" />
